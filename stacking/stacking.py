...
# read data
default_path = "/home/aduman/lcc"
import os
os.chdir(default_path)
application_train = pd.read_csv('/home/aduman/lcc/data/application_train.csv')
...
# output = train_test_split(application_train, label = 'TARGET', key = 'SK_ID_CURR', test_size = 0.3)
...
#Method 2
clf1 = XGBClassifier(learning_rate =0.5,n_estimators=300,max_depth=5,gamma=0,subsample=0.8, verbose=1)
...
sclf = StackingClassifier(classifiers=[clf1, clf2, clf3], meta_classifier=lr, verbose= 100)
